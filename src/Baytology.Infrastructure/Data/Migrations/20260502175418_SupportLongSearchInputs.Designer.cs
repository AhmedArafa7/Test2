...
namespace Baytology.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260502175418_SupportLongSearchInputs")]
    partial class SupportLongSearchInputs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Baytology.Domain.Properties.PropertyImage", b =>
                {
                    ...
                    b.ToTable("PropertyImages", null, t =>
                        {
                            t.HasCheckConstraint("CK_PropertyImages_BusinessRules", "LEN(LTRIM(RTRIM([Url]))) > 0 AND [SortOrder] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Baytology.Domain.Recommendations.RecommendationRequest", b =>
                {
                    ...
                    b.ToTable("RecommendationRequests", null, t =>
                        {
                            t.HasCheckConstraint("CK_RecommendationRequests_BusinessRules", "LEN(LTRIM(RTRIM([RequestedByUserId]))) > 0 AND LEN(LTRIM(RTRIM([SourceEntityType]))) > 0 AND [TopN] >= 1 AND [TopN] <= 50 AND (([Status] = 'Pending' AND [ResolvedAt] IS NULL) OR ([Status] <> 'Pending' AND [ResolvedAt] IS NOT NULL))");
                        });
                });
            ...
            modelBuilder.Entity("Baytology.Domain.Recommendations.RecommendationResult", b =>
                {
                    ...
                    b.ToTable("RecommendationResults", null, t =>
                        {
                            t.HasCheckConstraint("CK_RecommendationResults_BusinessRules", "[Rank] > 0 AND [SimilarityScore] >= 0 AND ([SnapshotPrice] IS NULL OR [SnapshotPrice] >= 0) AND ([RecommendedPropertyId] IS NOT NULL OR [ExternalReference] IS NOT NULL)");
                        });
                });
